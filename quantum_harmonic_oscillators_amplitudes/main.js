...
function main()
{
    ...
    {
        x_data_1.push(x);  
        y_data_1.push(psi(x, 1, m_e, w_e) * psi(x, 1, m_e, w_e)); 
        
        x_data_2.push(x);  
        y_data_2.push(psi(x, 2, m_e, w_e) * psi(x, 2, m_e, w_e)); 
        
        x_data_3.push(x);  
        y_data_3.push(psi(x, 3, m_e, w_e) * psi(x, 3, m_e, w_e)); 
        
        x_data_4.push(x);  
        y_data_4.push(psi(x, 4, m_e, w_e) * psi(x, 4, m_e, w_e)); 
        
        x_data_5.push(x);  
        y_data_5.push(psi(x, 5, m_e, w_e) * psi(x, 5, m_e, w_e)); 
    }
    
    var layout = {
    				title: {
    							text: "Harmonic Oscillators' Probability Amplitudes With Quantum Numbers n = 1, 2, 3, 4, 5",
    							front: {
